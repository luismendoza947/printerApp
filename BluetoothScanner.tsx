...
/**
 * Sample BLE React Native BluetoothScanner
 */
...
declare module 'react-native-ble-manager' {
  // enrich local contract with custom state properties needed by BluetoothScanner.tsx
...
const BluetoothScanner: React.FC<IBluetoothScanner> = ({ goBack }) => {
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.body}>
        <Pressable style={styles.scanButton} onPress={goBack}>
